...
#                 enuc_fac = torch.max(react_data.output_data[:, 13, :])
    ...
    def hyperparamter_optimization(self):
            ...
            model = OC_Net(react_data.input_data.shape[1]-1, react_data.output_data.shape[1]-1, hyper_results)
    ...
    def train(self, model, optimizer, num_epochs, criterion):
            ...
            for epoch in range(num_epochs):
                ...
                for batch_idx, (data, targets, E) in enumerate(self.train_loader):
    ...
    def plot(self):
            ...
            from .plotting2 import plotting_standard

            plot_class = plotting_standard(self.model, self.fields, self.enuc_fac, self.test_loader, self.cost_per_epoc, self.component_losses_test,
